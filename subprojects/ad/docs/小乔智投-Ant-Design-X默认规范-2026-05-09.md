...
2026-05-27 补充：Ant Design X 是会话与 AI 组件体系真源，不替代智投 Chat 的前端自主渲染协议。业务结果、时间线、工具卡、表格、图表、缺字段和来源的最终展示形态，以 `MASTER_SPEC.md` 的 Result / Timeline / MessagePart 协议，以及 `docs/review/智投Chat-前端自主渲染与色彩字体系统-2026-05-27.md` 为准。
