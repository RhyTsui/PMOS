...
const TESTS = [
  { id: 'MIG-014b', input: '指间山海 2026 年 2 月月报中，巨量引擎和腾讯广告在广告投放部的累计 ROI 对比', kw: ['巨量', '腾讯', 'ROI'] },
  { id: 'MIG-015b', input: '指间山海 2026-03-25 广告小时报表中，按媒体汇总全天数据，查看巨量引擎和腾讯广告的激活数与消耗', kw: ['巨量', '腾讯', '激活', '消耗'] },
  { id: 'MIG-016', input: '指间山海 - 国内 2026 年 3 月 18 日安卓应用激活数和首日 ROI', kw: ['安卓', '激活', 'ROI'] },
  { id: 'MIG-017', input: '指间山海 - 国内 2026-05-11~2026-05-17 和 2026-05-04~2026-05-10 的激活数对比', kw: ['激活', '对比', '5 月'] },
  { id: 'MIG-018', input: '指间山海 2026-05-11~2026-05-17 哪个媒体的累计 ROI 最高', kw: ['媒体', 'ROI', '最高'] },
  { id: 'MIG-019', input: '指间山海 2026-05-01~2026-05-07 激活到注册的转化率', kw: ['激活', '注册', '转化率'] },
  { id: 'MIG-020', input: '指间山海 - 国内 2026-05-01~2026-05-07 哪个媒体的激活成本最低', kw: ['媒体', '激活', '成本'] },
  { id: 'MIG-021', input: '指间山海 - 国内激活数最多的三个媒体', kw: ['激活', '媒体', '三'] },
];

(async () => {
  log('=== BATCH: MIG-014b to MIG-021 (8 tests) ===');
  ...
  fs.writeFileSync(path.join(REPORT_DIR, 'batch-mig014-021-report.json'), JSON.stringify({ timestamp: new Date().toISOString(), tests: results }, null, 2));
