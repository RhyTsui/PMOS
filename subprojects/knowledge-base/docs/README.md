...
- [知识库规划路径图 SVG](./svg/知识库规划路径图-cn.svg)
- [企业 AI 应用与知识资产权限架构 SVG](./svg/company-ai-kb-permission-architecture-cn.svg)
...
- [知识资产平台 v1.1 总目标与行动路径](./知识资产平台v1.1总目标与行动路径.md)
...
- [知识资产平台 v1.1 Demo 开发工程文档](./知识资产平台v1.1Demo开发工程文档.md)
- [知识资产平台 v1.1 页面清单](./知识资产平台v1.1页面清单.md)
- [知识资产平台 v1.1 Demo任务拆解](./知识资产平台v1.1Demo任务拆解.md)
...
- [v1.1 本地验证与生产任务包骨架](../src/v1.1/localValidationExecutionPlan.ts)

## 研究与评估

- [WeKnora适配性评估](./WeKnora适配性评估.md)
- [知识库竞品与开源方案对比](./知识库竞品与开源方案对比.md)
- [内部能力盘点](./内部能力盘点.md)
- [待主管拍板问题清单](./待主管拍板问题清单.md)
...
说明：
- `v1.1` 文档是当前正式规划基线。
- 旧版 `PRD.md`、`ARCHITECTURE.md`、`知识库整体规划.md` 继续保留，仅作为历史输入和演进参考。
