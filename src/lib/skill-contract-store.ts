...
const RAW_BUILTIN_SKILL_CONTRACTS: SkillContract[] = [
  ...
  },
  {
    ...
    workflow_steps: [
      ...
      { key: 'start_debug_task', label: '发起自动联调任务', tool_bindings: ['debug.start_task'], ui_component: 'debug_workbench' },
      { key: 'watch_debug_steps', label: '观测联调步骤和回传结果', tool_bindings: ['debug.watch_steps'], ui_component: 'debug_workbench' },
    ],
